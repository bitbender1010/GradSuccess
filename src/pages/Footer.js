...
<div style={{
    ...
    <div style={{
        ...
        <div> Home Page <span style={slash}> / </span> 
        Services and Prices <span style={slash}> / </span>
        About Us <span style={slash}> / </span>
        Contact <span style={slash}> / </span> Blog <span style={slash}> / </span>

        Privacy Policy <span style={slash}> / </span> 
        Website Terms of Use <span style={slash}> / </span> 
        Disclaimer <span style={slash}> / </span> 
        Client Terms of Service </div> <br/> <br/>
        <div> GradSuccess 1171 S. Robertson Blvd. #140 Los Angeles CA 90035 +1 (310) 815-9553
        © 2019 GradSuccess </div>
        </div>
