...
handleRedirect(event){
  if(event.target.value === 'essays'||
  'cv-resume'|| 'complete-packages'){
  ...
  render() {
    return(
      ...
      {/* Second */} <br/> <br/>
      <h3 for="program-select" css={steps}> STEP 2 </h3>

      <select id="program-select2" disabled={this.state.disabled} onChange={this.handleRedirect} css={inputTab}
      >
