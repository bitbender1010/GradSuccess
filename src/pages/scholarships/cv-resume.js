      ...
      <Layout>
        ...
        <div onClick={this.toggleTabs("review")} css={{
          ...
          <button css={{
            ...
            outline: 'none',
            cursor: 'pointer'
          }}> <h4 css={{marginBottom: '0px', color: this.state.reviewTab ? 'white' : '#19a99d'}}> CV Review</h4> </button>
        </div>
        <div onClick={this.toggleTabs("redraft")} css={{
          ...
          <button css={{
            ...
            verticalAlign: 'middle',
            cursor: 'pointer'
          }}> <h4 css={{marginBottom: '0px', color: this.state.redraftTab ? 'white' : '#19a99d'}}> CV Redraft </h4> </button>
        </div>
        </div>
